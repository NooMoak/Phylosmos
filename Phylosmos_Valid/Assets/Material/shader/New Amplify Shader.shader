...
Shader "FireToon"
{
	...
	SubShader
	{
		...
		{
			float4 color110 = IsGammaSpace() ? float4(0.9622642,0.9146348,0.3041118,0) : float4(0.9162945,0.8166835,0.07529138,0);
			...
			float smoothstepResult114 = smoothstep( 0.89 , 0.9 , ( ( ( tex2D( _Texture0, panner7 ).r * tex2D( _Texture0, panner15 ).r ) + tex2DNode53.r ) * tex2DNode53.r ));
			float smoothstepResult102 = smoothstep( 0.59 , 0.6 , ( ( ( tex2D( _Texture0, panner7 ).r * tex2D( _Texture0, panner15 ).r ) + tex2DNode53.r ) * tex2DNode53.r ));
			float4 color112 = IsGammaSpace() ? float4(1,0.5103594,0.03137255,0) : float4(1,0.2237553,0.002428216,0);
			float smoothstepResult105 = smoothstep( 0.0840832 , 0.09 , ( ( ( tex2D( _Texture0, panner7 ).r * tex2D( _Texture0, panner15 ).r ) + tex2DNode53.r ) * tex2DNode53.r ));
			o.Emission = ( ( color110 * ( smoothstepResult114 + smoothstepResult102 + smoothstepResult114 + smoothstepResult114 ) ) + ( color112 * ( smoothstepResult105 - smoothstepResult102 ) ) ).rgb;
...
/*ASEBEGIN
Version=16100
6.4;5.6;741;830;-556.8749;896.8383;3.088092;True;False
...
Node;AmplifyShaderEditor.SamplerNode;53;-465.0917,-19.12632;Float;True;Property;_TextureSample2;Texture Sample 2;2;0;Create;True;0;0;False;0;021019cf1f8947b4db0fde38320f4793;021019cf1f8947b4db0fde38320f4793;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;119;1458.821,-471.1572;Float;True;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;110;1551.6,-681.9548;Float;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;False;0;0.9622642,0.9146348,0.3041118,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;112;1594.671,181.9324;Float;False;Constant;_Color1;Color 1;4;0;Create;True;0;0;False;0;1,0.5103594,0.03137255,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;113;2244.727,-307.5542;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;125;1313.063,591.7828;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;125;0;53;1
WireConnection;0;2;113;0
WireConnection;0;9;125;0
ASEEND*/
//CHKSM=6F69D0E8D739E0E20EC2251C0D94F558946B0F62